...
curl -X POST -H "Content-Type: application/json" -d '{"user_id":4, "company":"renault", "activation_date":"2023-05-17", "deactivation_date":"2023-09-20", "password": "man"}' localhost:8080/api/manager
