...
export function SwitchInput(props) {
    ...
    const [local, formControlFieldProps, others] = splitProps(props, ["style", "onChange", "onFocus", "onBlur"], FORM_CONTROL_FIELD_PROP_NAMES);
