...
function RadioGroupItemInput(props) {
  ...
  const [local, others] = solidJs.splitProps(props, ["style", "aria-labelledby", "aria-describedby", "onChange", "onFocus", "onBlur"]);
  const ariaLabelledBy = () => {
...
function SwitchInput(props) {
  ...
  const [local, formControlFieldProps, others] = solidJs.splitProps(props, ["style", "onChange", "onFocus", "onBlur"], FORM_CONTROL_FIELD_PROP_NAMES);
  const {
    fieldProps
  } = createFormControlField(formControlFieldProps);
  const onChange = e => {
